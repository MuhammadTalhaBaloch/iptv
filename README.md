...
_Auto-updated after each workflow run — regenerated 2026-08-30 23:30 UTC._

### 📺 EPG — `Generate EPG`

• **in_progress** · last run [#67](https://github.com/MuhammadTalhaBaloch/iptv/actions/runs/33341076721) at 2026-08-30 23:09 UTC

| Metric | Value |
|---|---|
| Channels | 149,671 |
| Programmes | 2,330,030 |
| Countries | 260 |

### 🗂 Source registry — `Refresh browse registry`

✅ **success** · last run [#58](https://github.com/MuhammadTalhaBaloch/iptv/actions/runs/33341960340) at 2026-08-30 23:29 UTC

| Metric | Value |
|---|---|
| Total browse groups | 1,267 |
| Category | 30 |
| Country | 187 |
| Language | 201 |
| Region | 42 |
...
• **in_progress** · last run [#57](https://github.com/MuhammadTalhaBaloch/iptv/actions/runs/33341968018) at 2026-08-30 23:30 UTC

| Metric | Value |
|---|---|
| Catalog probed | 12,869 |
| ✅ Available (reachable) | 7,422 |
| ❌ Dead | 2,799 |
| ⚠️ Unreachable / couldn't reach | 2,648 |
| Snapshot | 2026-08-29 23:25 UTC · us probe |
